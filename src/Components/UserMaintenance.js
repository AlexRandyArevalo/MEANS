                    ...
                    <form onSubmit={handleValidate}>
                        <div className="row m-3">
                            ...
                            <div className="col-md-4">
                                <input onChange={(e) => setPhoneno(e.target.value)} value={phoneno} type="number" className="form-control" placeholder="___-___-__" required/>
                            </div>
                            ...
                            <div className="col-md-12 pt-3">
                                <button style={{ maxWidth: "20%", float: "right" }} type="submit" className="btn btn-purple pt-3">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
